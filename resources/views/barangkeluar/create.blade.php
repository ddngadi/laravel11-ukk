...
<div class="bg-dash-dark-2 py-4">
    <div class="container-fluid">
        <h2 class="h5 mb-0">Create Barang Keluar</h2>
    </div>
</div>
</br>
    ...
    @endif
        <form method="POST" action="{{ route('barangkeluar.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="date" name="tgl_keluar" id="tgl_keluar" class="form-control text-gray-100" required>
            </div>

            <div class="form-group">
                <label for="qty_keluar">Jumlah Keluar:</label>
                <input type="number" name="qty_keluar" id="qty_keluar" class="form-control text-gray-100" required>
            </div>
