...
<div class="bg-dash-dark-2 py-4">
    <div class="container-fluid">
        <h2 class="h5 mb-0">Edit Barang Masuk</h2>
    </div>
</div>
</br>
    ...
    <div class="container-fluid">        
        <form method="POST" action="{{ route('barangmasuk.update', $barangmasuk->id) }}">
            ...
            <div class="form-group">
                ...
                <input type="date" name="tgl_masuk" id="tgl_masuk" class="form-control text-gray-100" value="{{ $barangmasuk->tgl_masuk }}">
            </div>

            <div class="form-group">
                <label for="qty_masuk">Jumlah Masuk:</label>
                <input type="number" name="qty_masuk" id="qty_masuk" class="form-control text-gray-100" value="{{ $barangmasuk->qty_masuk }}">
            </div>

            <div class="form-group">
                <label for="barang_id">Barang:</label>
                <select name="barang_id" id="barang_id" class="form-control text-gray-100">
